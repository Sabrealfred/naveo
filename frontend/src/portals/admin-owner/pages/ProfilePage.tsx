  ...
  return (
    <div style={{ padding: '24px' }}>
      <Space align="center" style={{ marginBottom: 24 }}>
        ...
        <Tag color="gold" icon={<CrownOutlined />}>Platform Owner</Tag>
      </Space>
      <Text type="secondary" style={{ display: 'block', marginBottom: 24 }}>
        Manage your account information and platform preferences
      </Text>
          ...
          <Card style={{ marginTop: 16 }} title="Account Stats">
            <Space direction="vertical" size="small" style={{ width: '100%' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Tag color="gold">Platform Owner</Tag>
              </div>
            </Space>
          </Card>
        </Col>
                    ...
                    children: (
                      <>
                        <Form.Item label="Job Title" name="job_title">
                          <Input prefix={<IdcardOutlined />} placeholder="Chief Executive Officer" />
                        </Form.Item>
                        ...
                        <Row gutter={16}>
                          ...
                          <Col xs={24} md={12}>
                            <Form.Item label="Company" name="company_name">
                              <Input placeholder="Naveo Platform" />
                            </Form.Item>
                          </Col>
                        </Row>
